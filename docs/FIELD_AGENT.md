...
- **Без повторних візитів:** бот стежить за цим автоматично — магазин, який
  ...
  ніхто не перевіряв.
- **Без подвійної роботи двох агентів:** щойно ви обираєте магазин у
  `/visit`, або надсилаєте маршрут через `/route` (одразу до 12 магазинів),
  кожен з них на 12 годин «закріплюється» за вами — інший агент його не
  побачить у своєму списку й не зможе вибрати вручну, аж доки ви не
  завершите (чи не мине 12 годин без завершення — тоді закріплення
  автоматично знімається). Якщо магазин справді обстежено, він одразу
  переходить під 6-місячне обмеження вище.
...
3. У **@Secondhandlvivbot** надішліть **/route** (або **/agent → 🧭
   Маршрут**) і натисніть кнопку — відкриється карта з вільними магазинами
   (не обстеженими останні 6 місяців і не закріпленими за іншим агентом).
   Оберіть на карті ті, що плануєте відвідати сьогодні (до 12), і
   натисніть «Надіслати». Бот закріпить їх за вами на 12 годин, надішле
   піший маршрут із посиланням на карту та покроковою навігацією Google
   Maps, і закріпить це повідомлення у чаті. Необов'язково, але планує
   день і уникає поворотів назад.
...
| 5 | **Години роботи** | спершу: чи однакові щодня? Якщо так — одна відповідь (напр. `10:00–20:00`, або «зачинено»). Якщо ні — окремо будні (Пн–Пт) і вихідні (Сб–Нд), бо на дверях магазину графік майже завжди ділиться саме так. З нагадуванням спершу звірити з тим, що вже записано на карті |
...
|---|---|---|
| `/route` | агент | карта вільних магазинів — оберіть до 12, закріпіть за собою на 12 год. (посилання на карту + навігація Google Maps) |
