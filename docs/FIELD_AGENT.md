...
3. У **@Secondhandlvivbot** надішліть **/route** (або **/agent → 🧭
   ...
   поворотів назад. Поки маршрут активний (12 годин), список вибору
   магазину в **/visit** показує лише його ще не пройдені зупинки — жоден
   сторонній магазин не підмішається, і список не «стрибає» щоразу, коли
   ви ділитесь новою геолокацією.
