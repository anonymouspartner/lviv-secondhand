...
- **Без подвійної роботи двох агентів:** щойно ви обираєте магазин у
  `/visit`, він на 12 годин «закріплюється» за вами — інший агент його не
...
3. У **@Secondhandlvivbot** надішліть **/route** (або **/agent → 🧭
   ...
   поворотів назад. Це лише порада: **/visit** завжди сам показує
   найближчі до вас магазини в момент запиту, незалежно від
   запланованого маршруту — обирайте будь-який зі списку в будь-якому
   порядку.
